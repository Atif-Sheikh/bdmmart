...
import { Styles, Languages, Color, Config, Constants, Events, withTheme } from "@common";
      ...
      <View style={[styles.tabView, {backgroundColor: background}]}>
        ...
        {this.state.tabIndex === 0 && (
          <View style={[styles.description, {backgroundColor: lineColor}]}>
            <WebView textColor={text} html={`<p>${this.props.product.description}</p>`} />
          </View>
        )}
  ...
  render() {
    ...
    const renderButtons = () => (
      <View
        ...
        <View style={[styles.buttonContainer, Config.Theme.isDark && {backgroundColor: lineColor}]}>
          <Button
            type="image"
        ...
        <View style={styles.price_wrapper}>
          <Rating rating={Number(product.average_rating)} size={19} />
            ...
            <TouchableOpacity onPress={this._writeReview}>
              <Text
                style={[styles.textRating, {color: text} ]}>
    ...
    const renderTitle = () => (
      <View style={{ justifyContent: "center", marginTop: 6, marginBottom: 8 }}>
        <Text style={[styles.productName, {color: text}]}>{product.name}</Text>
        <View
          style={{
            flexDirection: "row",
          ...
          <Animatable.Text animation="fadeInDown" style={[styles.productPrice, {color: text}]}>
            {productPrice}
          </Animatable.Text>
          {isOnSale && (
            <Animatable.Text animation="fadeInDown" style={[styles.sale_price, {color: text}]}>
              {productRegularPrice}
            </Animatable.Text>
          )}
        </View>
