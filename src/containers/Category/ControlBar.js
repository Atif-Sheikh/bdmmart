...
import { Color, Images, Icons, Styles, withTheme, Config } from "@common";
  ...
  render() {
    ...
    return (
      <View
        style={[
          styles.container,
          { height: isVisible ? controlBarHeight : 0, backgroundColor: background },
        ]}>
        <TouchableOpacity
          ...
          <Image
            ...
            style={[styles.iconStyle, styles.dark, isDark && {tintColor: "#fff"}]}
          />
