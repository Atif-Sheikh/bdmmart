      ...
      <View style={styles.container}>
        <ScrollView>
          <View style={css.rowEmpty}>
            <Text style={[styles.label, {color: text}]}>{Languages.SelectPayment}:</Text>
          </View>
          ...
          <ConfirmCheckout couponAmount={this.props.couponAmount} discountType={this.props.discountType} shippingMethod={this.getShippingMethod()} totalPrice={this.props.totalPrice}/>
        </ScrollView>
